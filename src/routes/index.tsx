    ...
    <div className="mx-auto max-w-7xl space-y-7">
          ...
          <div className="rounded-3xl border border-border bg-sidebar p-6 text-sidebar-foreground shadow-elevated">
            ...
            <div className="mt-5 space-y-3">
              <ConnectionStatus
                label="IA"
                status="warning"
                detail="OpenAI roda no Motor Local EXE. Vercel/Supabase apenas enfileiram e publicam."
              />
              <ConnectionStatus
                label="Meta"
                status="warning"
      ...
      <div className="rounded-3xl border border-border bg-card p-5 shadow-soft">
        <div className="flex items-center gap-2 text-sm text-muted-foreground">
          <Database className="h-4 w-4 text-primary" /> Dados do painel vêm do Supabase. Geração pesada fica no Motor Local EXE.
        </div>
      </div>
    </div>
  );
